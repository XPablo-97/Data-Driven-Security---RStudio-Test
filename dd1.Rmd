...
Primero reemplazamos los '-' por '0' epa_http\$x7NUM \<- y después hacemos la media.
>>>>>>> 12d52a36d2a5677009e75fd6c752d488d4a05a94

```{r 1b, echo=FALSE}
epa_http$x7NUM<-gsub("-", "0", epa_http[,7])
epa_http$x7NUM<-as.numeric(epa_http$x7NUM)
mean(epa_http$x7NUM, na.rm = TRUE)
```
